    ...
    <div className='custom-container space-y-10xl py-6xl'>
      ...
      <header className='gap-md flex flex-wrap items-center justify-between'>
        <div className='space-y-xs'>
          <h1 className='display-xl-extrabold text-foreground'>
            Design System Test
          </h1>
          <p className='text-md-regular text-muted-foreground'>
            Verifying design tokens from{' '}
            <code className='bg-muted rounded-xs px-1'>globals.css</code>
          </p>
        </div>
      </header>
      ...
      <section className='space-y-4xl' aria-labelledby='buttons-heading'>
        <div className='flex items-center justify-between'>
          <h2 id='buttons-heading' className='display-sm-bold text-foreground'>
